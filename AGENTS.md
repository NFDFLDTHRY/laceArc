...
Philosophy of operating the lace: [`docs/clock/philosophy-map.md`](docs/clock/philosophy-map.md). HCC-A, Coffee Cup, Water/Proofing are gears required to operate upon the workpiece. They are not WORD/POINTER. Ledger ops stay inside HCC-A. Clutch (Water) before torque. Phase (Cup) tooth 3 is the work window. Hologram touch [`docs/hologram/perceived-reality-story-defense.png`](docs/hologram/perceived-reality-story-defense.png): overlap is mesh; story defense is PFC-wins; “signal arrives, meaning does not” is a missing route in the other holder, not emission.
