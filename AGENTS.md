...
Reason model: `docs/reason-model-map.md` (a shoe lace in the hands). History: `docs/history-recovered-2026-09-18.md`, `docs/history-recovered-pass-2-2026-09-18.md`, `docs/history-recovered-pass-3-2026-09-18.md`. Ancestry and rejected walkers. Do not revive lace_walk.py, mirrors, lookups, BFS closures, sorted touches, closed rings, eleven-rule schedulers, mutable continuation slots, or C-machine metrics. Do not treat “touch grows lace” or exact-match ties as pointer-emission. Do not treat D06 substitution as a write. Do not treat codec roundtrip or P02 StructureBytes as possession of the strand. Do not manufacture cat/cat-1. Do not swap graphics bytes because a recovered PNG matches the picture.
