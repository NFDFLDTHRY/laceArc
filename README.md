...
| [docs/lace-projection-brief.md](docs/lace-projection-brief.md) | [PROPOSAL] Plan for the Lace visualizer: Graphic D as a Layer III view. Eleven rows, no emitter. |
| [docs/lace-projection-review-prompt.md](docs/lace-projection-review-prompt.md) | Agent prompt: attack the projection fence before anything is built. Carries what review pass 1 already found. |
