...
| [docs/shadow-clock-gear-contracts-second-reading.md](docs/shadow-clock-gear-contracts-second-reading.md) | [PROPOSAL] Bounded counter-reading of the gear contracts. Six findings the primary walk does not carry. |
