...
**Current reconciliation:** 2026-09-20, [repository update pass 3](../plans/repo-update-pass-3-evidence.md), executed locally against published pass 2 at `e14b13c`. Read the [pass 2](../plans/repo-update-pass-2-evidence.md) and [pass 1](../plans/repo-update-pass-1-evidence.md) receipts as dated records. Current summaries qualify their scope; no model or emission acceptance is asserted. Source and synthetic results remain separate from pending browser, device and designated-renderer work; main publication does not promote the pinned ixp2 release.
...
| [the door](../plans/reduction-pass-1-findings.md), “S” and “The door” | **S = 21 documents** was the reduction's dated base reading set, plus four PNGs, manifest and law. Current target work also reads [rust-target Pass 1 / Page G](../clipboards/rust-target-clipboard.md) and current [update-pass evidence](../plans/repo-update-pass-3-evidence.md); follow each task's source/consumer closure | dated measurement plus current routing; not an exhaustive permanent allow-list |
...
2. **Read the dated door** ([S and The door](../plans/reduction-pass-1-findings.md)), the [pass 1 evidence](../plans/repo-update-pass-1-evidence.md), [pass 2 findings/results](../plans/repo-update-pass-2-evidence.md) and [pass 3 corrections/results](../plans/repo-update-pass-3-evidence.md), the companion's “Systems-level audit (pass 27)” / “Execution-model reading (pass 28)” and any later scope note, and [rust-target “Pass 1” / “Page G” with its current addendum](../clipboards/rust-target-clipboard.md#repository-update-pass-2--target-evidence-carry) for target work. Expand that base by the exact sources and consumers of your task; do not stop at an old document count or line range.
