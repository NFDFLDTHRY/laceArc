...
**Current reconciliation:** 2026-09-20, [repository update pass 2](../plans/repo-update-pass-2-evidence.md), following the published [pass 1 record](../plans/repo-update-pass-1-evidence.md). Current summaries below preserve the original record and qualify its scope; no model or emission acceptance is asserted. Pass 2's source and synthetic evidence must be read separately from any pending browser, device or designated-renderer work.
