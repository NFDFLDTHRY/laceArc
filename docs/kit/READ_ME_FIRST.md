...
| [docs/kit/downstream-audit.md](downstream-audit.md) | Evidence, concrete failure paths, source corrections, and agent challenge cases. Dated snapshot at the THEN pin. |
