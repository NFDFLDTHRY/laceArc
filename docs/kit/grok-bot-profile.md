...
Repo law (same ASCII, with preamble): [`docs/law-why-these-documents.md`](../law-why-these-documents.md). The Explanation block below is a **transport copy** of its fenced block, regenerated byte for byte at revision `e21cf39`. Where they differ, the live law wins.
