...
| File | Use | Status |
|---|---|---|
| [READ_ME_FIRST.md](READ_ME_FIRST.md) | Package door: what the documentation package is and what it does not establish | **STALE** pin `4fe984b` — read live [AGENTS.md](../../AGENTS.md) instead |
