...
| [rust-target-pass-1-plan.md](rust-target-pass-1-plan.md) | **`PLAN` — shelf 10 pass 1, the mapping.** The desired result stated as a recipe B with seven checkable rows (b1–b7); measured: the book closes b4–b6 alone, b1–b3 wait on A4, b7 is ruling R12; pages A–H, X planned; nothing run |
