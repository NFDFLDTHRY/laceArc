...
| [rust-target-locators.md](rust-target-locators.md) | **Locator extract — three runs, 231 rows.** wasm64 `30597–30689` (57) · wasm32 `30210–30471` (173) · one line `30154` (1), cut mechanically at the SHA and verified after writing. **Not the book and never authority** — it carries what stands at the numbers this shelf cites, so a session never handed the source can check the claims. 0.3% of the book. Pass 1 found pass 0's header span overshoots by 11 lines into the `*-windows-gnu` page |
