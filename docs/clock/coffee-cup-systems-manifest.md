...
**Behavioral-goal clipboard status, clarified 2026-09-21:** HCC-A, The Coffee Cup, and Where the Water Is Loud are conceptual reference / behavioral-goal sources under the [current law](../law-why-these-documents.md#conceptual-reference-documents). **This file is the Coffee Cup source clipboard.** C1–C5, the recirculating event model, packet distinctions, intervention window, and cross-source meshes remain available as **candidate causal machinery for the laceArc lab**. They are not automatically required LaceArc stages, runtime dependencies, Core rows, or legal-append conditions merely because the source describes them. Historical readings remain recorded at their original evidence strength.
