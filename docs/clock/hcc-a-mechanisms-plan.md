...
**Current reading, 2026-09-21:** HCC-A is a conceptual reference / behavioral-goal source under the [current law](../law-why-these-documents.md#conceptual-reference-documents). The gear, housing, oil, shaft, and pipeline language below is **candidate machinery for laboratory testing**, retained from the source analysis. It establishes no required holder component, runtime dependency, Core operator, or condition for legal Lace append by existence alone. Independent Graphic D exclusions and the pointer-emission gate remain intact.
