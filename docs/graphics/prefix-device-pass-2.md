...
- Did not edit `docs/pointer-emission.md`.
- Did not treat session speech as in-repo SPOKEN on that file.

Pass 3 stays queued until a human sentence on I and/or II exists **in-repo**.
