...
## Iteration 2 — queued (not opened until named)

Leftover from iteration 1, in order. These are **iteration 2 passes 1–6**, not B-pass-7.

| i2 pass | Queued act | Plan on disk |
|---|---|---|
| 1 | B7–B9 grain (thread / remains / interior) | [`graphic-b-ascii-pass-3-plan.md`](graphic-b-ascii-pass-3-plan.md) |
