...
| [math-execution-model.md](math-execution-model.md) | Current mathematical construction: WORD/root/RootTouch, binary Join, finite-sample grounding, derived multi-scale sampling/search; exact retention/materialization and G1 remain open |
