...
| File | Job |
|---|---|
| [math-execution-wasm-crosswalk-pass-2-plan.md](math-execution-wasm-crosswalk-pass-2-plan.md) | `[PLAN]` Pass 2: math-execution × WASM **KEEP/FORBID/SILENT reading**; Φ `[GAP]`; bridge still blocked |
...
| [verification-iter4-pass-5-plan.md](verification-iter4-pass-5-plan.md) | `[PLAN]` iteration 4 pass 5: the docket — fourteen items in four groups, one struck because it was already correct |
