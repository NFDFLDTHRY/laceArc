...
| File | Job |
|---|---|
| [math-execution-model-pass-4-plan.md](math-execution-model-pass-4-plan.md) | `[PLAN]` Pass 4: **adversarial non-examples** (+ optional D1 prefixes) under Pass 2/3; Φ `[GAP]`; not an emitter |
