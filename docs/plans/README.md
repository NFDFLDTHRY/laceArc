...
| File | Job |
|---|---|
| [math-execution-model-pass-5-plan.md](math-execution-model-pass-5-plan.md) | `[PLAN]` Pass 5: Graphics A–C as Contract III **projection readings** under Pass 2 π; Φ `[GAP]`; not an emitter |
